...
- [codel00p-providers](core/crates/codel00p-providers): provider registry,
  ...
  Anthropic Messages transport, OpenAI Responses transport, tool calls, route
...
OpenAI Responses, Anthropic Messages, and Chat-Completions-compatible providers,
inspect and modify a workspace through permissioned tools, run commands, inspect
git state, persist and resume sessions, stream events, connect to MCP tools,
extract candidate memories, and reuse approved project memory in future runs.
